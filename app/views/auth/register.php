    ...
    <div class="animate-fade-in">
        <div class="card p-4 border-0 shadow-lg glass-card" style="width: 100%; max-width: 450px;">
            <h3 class="text-center mb-4 fw-bold text-uppercase"
                style="font-family: 'Orbitron', sans-serif; color: var(--header-red); letter-spacing: 2px;">Identity
                Creation</h3>
            ...
            <form action="<?php echo url('/register'); ?>" method="POST">
                <div class="mb-3">
                    <label class="form-label small text-uppercase fw-bold opacity-50">Full Designation (Name)</label>
                ...
                <button type="submit" class="btn btn-primary w-100 py-3 shadow-neon">Initialize Identity</button>
            </form>

            <p class="mt-4 text-center small opacity-75 mb-0">
                Existing identity check? <a href="<?php echo url('/login'); ?>"
                    class="text-danger text-decoration-none fw-bold">Access Portal</a>
            </p>
        </div>
    </div>
</div>
